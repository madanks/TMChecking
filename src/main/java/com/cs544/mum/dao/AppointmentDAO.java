...
public interface AppointmentDAO extends JpaRepository<Appointment, Long> {
	...
	@Query("select a from Appointment a where a.total>a.enrolled and DATE_FORMAT(a.date, '%Y-%m-%d') between :start and :end")
	public List<Appointment> findBydateBetween(@Param("start") String start, @Param("end") String end);
