...
<head>
    ...
    <!-- CSS Page Style -->    
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/pages/page_error4_404.css">
...
<body>
                ...
                <div class="error-v4">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <a class="btn-u btn-brd btn-u-light" href="${pageContext.request.contextPath}/home"> Go Back to Main Page</a>
                        </div> 
                    </div> 
                </div>
            </div>
    ...
    <div class="container sticky-footer">
        <p class="copyright-space">
            2016 &copy; Maharishi TM Checking. ALL Rights Reserved. 
        </p>  
    </div>
    <!--=== End Sticky Footer ===-->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/plugins/backstretch/jquery.backstretch.min.js"></script>
<!-- JS Customization -->
...
<script type="text/javascript">
    $.backstretch([
      "${pageContext.request.contextPath}/resources/img/img2.jpg"
      ])
</script>
